...
import com.example.schoolairdroprefactoredition.activity.transactionstate.TransactionStateActivity;
...
public class OnGoingRecyclerAdapter extends BaseQuickAdapter<TestOnGoingBean, BaseViewHolder> {
    ...
    protected void convert(@NotNull BaseViewHolder holder, TestOnGoingBean testOnGoingBean) {
        ...
        holder.itemView.setOnClickListener(v -> TransactionStateActivity.start(getContext()));
    }
