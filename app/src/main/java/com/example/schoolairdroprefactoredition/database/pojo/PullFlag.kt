...
data class PullFlag(
         ...
         * 1、上一次获取的离线消息条数等于[com.example.schoolairdroprefactoredition.utils.ConstantUtil.DEFAULT_PAGE_SIZE]
         *   则下一次请求的任务便是获取接下来默认条离线和ack上一批接受的消息
         * 2、上一次获取的离线消息条数小于[com.example.schoolairdroprefactoredition.utils.ConstantUtil.DEFAULT_PAGE_SIZE]
