...
import static com.blankj.utilcode.util.BarUtils.setStatusBarColor;
...
public class StatusBarUtil {
     ...
     */
    public static void setStatusTextColor(Activity activity, int backgroundColor, boolean isLightMode) {
...
//        }
    ...
    private static boolean MIUISetStatusBarLightMode(Activity activity) {
    ...
    private static boolean FlymeSetStatusBarLightMode(Activity activity) {
        boolean result = false;
        try {
            WindowManager.LayoutParams lp = activity.getWindow().getAttributes();
